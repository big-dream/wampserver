...
$w_settings = array(
	...
	'HomepageAtStartup' => 'ʼνοιγμα Αρχικής Wampserver με την εκκίνηση',
...
$w_empty = 'ʼδειασμα';
$w_misc = 'Διάφορα';
$w_emptyAll = 'ʼδειασμα ΌΛΩΝ';

$w_emptyLogs = 'ʼδειασμα καταγραφών';
$w_emptyPHPlog = 'ʼδειασμα καταγραφής σφαλμάτων PHP';
$w_emptyApaErrLog = 'ʼδειασμα καταγραφής σφαλμάτων Apache';
$w_emptyApaAccLog = 'ʼδειασμα καταγραφής πρόσβασης Apache';
$w_emptyMySQLog = 'ʼδειασμα καταγραφής MySQL';
$w_emptyMariaLog = 'ʼδειασμα καταγραφής MariaDB';
$w_emptyAllLog ='ʼδειασμα όλων των αρχείων καταγραφής';
